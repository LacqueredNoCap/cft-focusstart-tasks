...
public class HighScoresWindow extends JDialog {
    public static final String DEFAULT_RECORD_TEXT = "No record yet";
    ...
    public void setNoviceRecord(PlayerRecord record) {
        noviceRecordLabel.setText(record.toString());
    }

    public void setMediumRecord(PlayerRecord record) {
        mediumRecordLabel.setText(record.toString());
    }

    public void setExpertRecord(PlayerRecord record) {
        expertRecordLabel.setText(record.toString());
    }
