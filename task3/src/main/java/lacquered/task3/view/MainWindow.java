...
public class MainWindow extends JFrame {
    ...
    public MainWindow() {
        super("Minesweeper");
        setIconImage(GameImage.WINDOW_ICON.getImageIcon().getImage());
    ...
    public void setHighScoresMenuListener(ActionListener listener) {
        highScoresMenu.addActionListener(listener);
    }

    public void setSettingsMenuListener(ActionListener listener) {
        settingsMenu.addActionListener(listener);
    }

    public void setExitMenuListener(ActionListener listener) {
    ...
    public void setMinesCount(int bombsCount) {
    ...
    public void createGameField(int rowsCount, int colsCount) {
        ...
        addBombCounterLabel(bombsCounterLabel = new JLabel("0"));
        addBombCounterImage();
        pack();
    ...
    private void addBombCounterLabel(JLabel bombsCounterLabel) {
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.anchor = GridBagConstraints.EAST;
        gbc.gridx = 2;
